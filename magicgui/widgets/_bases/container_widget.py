...
class ContainerWidget(Widget):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kwargs.setdefault("widget_type", use_app().get_obj("EmptyWidget"))
        super().__init__(**kwargs)
    ...
    def labels(self, value: bool):
        ...
        # for index, _ in enumerate(self._widgets):
        #     widget = self.pop(index)
        #     self.insert(index, widget)
    ...
    @layout.setter
    def layout(self, layout: _Layout | str):
        if isinstance(layout, str):

            layout: _Layout = {"vertical": VBoxLayout, "horizontal": HBoxLayout}[
                layout.lower()
